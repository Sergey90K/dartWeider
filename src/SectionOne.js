...
function SectionOne(props){
    return(
        ...
        <img src= {dethStar} alt="death star" className="death-star-img"/>
        <img src= {dartWeider} alt="darth vader" className="dart-vader-img"/>
        <div className="container">
            ...
            <div className="about-content">
                ...
                <h2 className="about-proffesion">Владыка Ситх</h2>
            
                <h1 className="about-name">Дарт Вейдер <br/> Энакин Скайуокер</h1>
            
                <ul className="about-position">
                    <li className="about-position">
                        <p className="about-positions-text">Инженер-конструктор</p> 
                    </li> 
                    <li className="about-position">
                        <p className="about-positions-text">Командор армии</p> 
                    </li> 
                    <li className="about-position">
            ...
            <div className="about-content-row">
                <p className="about-description">Принесение клятвы верности Лорду Ситху <br/> избавит тебя от обуз морали и этики
                </p>
                <p className="about-description">Покой — это ложь. Есть только страсть.
                </p>
            </div>

            <div className="about-social">
                <a href="https://www.youtube.com/user/starwars" className="social-link">
                ...
                <a href="https://www.instagram.com/starwars/" className="social-link">
                ...
                <a href="https://twitter.com/starwarsuk" className="social-link">
